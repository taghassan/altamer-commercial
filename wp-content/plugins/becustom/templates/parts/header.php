...
<?php if( WHITE_LABEL ): ?>
	<h1><?php echo __( 'Welcome to WordPress', 'becustom' ); ?></h1>
<?php else: ?>
	<h1><?php echo __( 'Welcome to BeCustom', 'becustom' ); ?></h1>
<?php endif; ?>

<p class="about-text">
	<?php echo __( 'Here you can customize our theme, even more!', 'becustom' ); ?>
</p>

<?php
	$current_screen = get_current_screen();
	$current_screen = $current_screen->base;
	$betheme_label = 'betheme';
	$betheme_label = str_replace(' ', '-', apply_filters('betheme_label', $betheme_label));
?>

<h2 class="nav-tab-wrapper wp-clearfix">
	<a href="admin.php?page=be_custom" class="nav-tab<?php if( $current_screen == strtolower($betheme_label).'_page_be_custom' ) echo ' nav-tab-active'; ?>"><?php echo __( 'General', 'becustom' ); ?></a>
	<a href="admin.php?page=be_custom_branding" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_branding' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Branding' , 'becustom' ); ?></a>
	<a href="admin.php?page=be_custom_built_in_features" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_built_in_features' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Built-in features', 'becustom' ); ?></a>
	<a href="admin.php?page=be_custom_wp_login" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_wp_login' ) echo ' nav-tab-active'; ?>"><?php echo __( 'WP Login', 'becustom' ); ?></a>
	<a href="admin.php?page=be_custom_be_dashboard" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_be_dashboard' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Be dashboard', 'becustom' ); ?></a>
	<a href="admin.php?page=be_custom_advanced" class="nav-tab<?php if( $current_screen == 'admin_page_be_custom_advanced' ) echo ' nav-tab-active'; ?>"><?php echo __( 'Advanced', 'becustom' ); ?></a>
</h2>
