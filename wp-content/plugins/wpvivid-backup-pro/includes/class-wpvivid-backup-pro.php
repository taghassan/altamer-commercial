...
class WPvivid_backup_pro
{
    ...
    public function wpvivid_mainwp_record_array($record)
    {
        ...
        if(isset($data['summary']))
        {
            ...
            {
                $data['summary'] = apply_filters('wpvivid_white_laebl_display_pro_ex', $data['summary']);
                $record['summary']=$data['summary'];
            }
        }
        ...
        if(isset($data['meta']['name']))
        {
            ...
            {
                $data['meta']['name'] = apply_filters('wpvivid_white_laebl_display_pro_ex', $data['meta']['name']);
                $record['meta']=$data['meta'];
            }
        }
    ...
    public function set_auto_update()
    {
        ...
        if(isset($auto_update) && $auto_update !== false)
        {
            if($auto_update == '1')
            {
                ...
                update_option('wpvivid_dashboard_auto_update','on');
            }
        }
    }
    ...
    public function wpvivid_hide_need_update_pro_notice()
    {
        ...
        try {
            update_option('wpvivid_need_update_pro_notice', time() + 604800);
            $ret['result'] = 'success';
        ...
        if ($restore->has_restore())
        {
            ...
            if ($restore_status === WPVIVID_PRO_RESTORE_COMPLETED)
            {
                ...
                if($need_review=='not')
                {
                    ...
                    update_option('wpvivid_review_msg',$msg);
                }
                else{
                    if(!$migrate_notice)
                    {
