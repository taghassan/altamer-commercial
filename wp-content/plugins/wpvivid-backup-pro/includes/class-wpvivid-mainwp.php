...
class WPvivid_MainWP_Function
{
    ...
    public static function wpvivid_update_upgrade_task($site_id, $options){
        ...
        update_option('wpvivid_upgrade_plugin_task_mainwp', $upgrade_tasks);
    }
        ...
        try
        {
            ...
            if(isset($options[$site_id]) && !empty($options[$site_id]))
            {
                ...
                if($need_delete_opt){
                    ...
                    update_option('wpvivid_upgrade_plugin_task_mainwp', $options);
                }
            }
        }
        catch (Exception $e)
    ...
    public function wpvivid_login_account_addon_mainwp($data){
        try
        {
            if(isset($data['login_info']['wpvivid_dashboard_info'])){
                update_option('wpvivid_dashboard_info', $data['login_info']['wpvivid_dashboard_info']);
            }
            if(isset($data['login_info']['wpvivid_pro_user'])){
                update_option('wpvivid_pro_user', $data['login_info']['wpvivid_pro_user']);
            }
    ...
    public function wpvivid_get_wpvivid_info_addon_mainwp_ex($data)
    {
        ...
        $data['setting_addon']['wpvivid_uc_delete_media_when_delete_file']=get_option('wpvivid_uc_delete_media_when_delete_file',false);
