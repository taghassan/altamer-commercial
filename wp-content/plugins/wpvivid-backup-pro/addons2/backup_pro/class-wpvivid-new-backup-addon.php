...
class WPvivid_New_Backup_Page_addon
{
    ...
    public function default_exclude_folders($folders)
    {
        ...
        $exclude_default[18]['type'] = 'file';
        $exclude_default[18]['path'] = WP_CONTENT_DIR.'/'.'mysql.sql';  //mysql
        ...
        try
        {
            if(isset($_POST['website_item'])&&!empty($_POST['website_item']))
            {
                ...
                if($website_item === 'database')
                {
                    ...
                    update_option('wpvivid_custom_select_website_size_ex', $website_size);
                ...
                if($website_item === 'core')
                {
                    ...
                    $core_folder_exclude_list = array('wp-admin', 'wp-includes');
    ...
    public function get_backup_default_settings()
    {
        ...
        {
            $settings['db_connect_method']=isset($common_setting['db_connect_method'])?$common_setting['db_connect_method']:'pdo';
    ...
    public function get_backup_adaptive_settings()
    {
        ...
        $options['db_connect_method']=isset($options['db_connect_method'])?$options['db_connect_method']:'pdo';
        $options['memory_limit']=isset($options['memory_limit'])?$options['memory_limit']:'256M';
    ...
    public function backup()
    {
        ...
        update_option('wpvivid_backup_report', $this->backup_type_report);
            ...
            foreach ($finished_tasks as $id => $finished_task)
            {
                if($finished_task['status']['str']=='completed'&&isset($finished_task['options']['export']))
                {
                    ...
                    else if($finished_task['options']['export']=='auto_migrate')
                    {
                        ...
                        update_option('wpvivid_display_auto_migration_success_notice', true);
                    }
                }
            }
        }
    ...
    public function clean_backup_data_event($task_id)
    {
        ...
        update_option('wpvivid_clean_task_ex',$tasks);
