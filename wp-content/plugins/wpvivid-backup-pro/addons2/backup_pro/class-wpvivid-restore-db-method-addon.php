...
class WPvivid_Restore_DB_WPDB_Method_Addon
{
...
class WPvivid_Restore_DB_PDO_Mysql_Method_Addon
{
    private $db;
    public $max_allow_packet;
    public $skip_query=0;
...
class WPvivid_Restore_DB_Method_Addon
{
    private $db;
    private $type;
    ...
    public function __construct()
    {
        ...
        {
            $this->db =new WPvivid_Restore_DB_WPDB_Method_Addon();
            $this->type='wpdb';
        }
        else{
            $this->db =new WPvivid_Restore_DB_PDO_Mysql_Method_Addon();
            $this->type='pdo_mysql';
        }
    }
