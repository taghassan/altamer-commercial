...
class WPvivid_Setting_addon
{
    ...
    public function wpvivid_set_general_setting($setting_data, $setting, $options)
    {
        ...
        //$setting['max_remote_backup_count'] = intval($setting['max_remote_backup_count']);
        ...
        //$setting_data['wpvivid_local_setting']['save_local'] = $setting['save_local'];
        ...
        //$setting_data['wpvivid_common_setting']['max_backup_db_count'] = $setting['max_backup_db_count'];
        //$setting_data['wpvivid_common_setting']['max_remote_backup_count'] = $setting['max_remote_backup_count'];
        //$setting_data['wpvivid_common_setting']['max_remote_backup_db_count'] = $setting['max_remote_backup_db_count'];
        ...
        //$setting_data['wpvivid_common_setting']['max_remote_backup_count'] = intval($setting['max_remote_backup_count']);
        //$setting_data['wpvivid_common_setting']['max_remote_backup_db_count'] = intval($setting['max_remote_backup_db_count']);
        ...
        $setting_data['wpvivid_common_setting']['rollback_max_backup_count'] = intval($setting['rollback_max_backup_count']);
        $setting_data['wpvivid_common_setting']['rollback_max_remote_backup_count'] = intval($setting['rollback_max_remote_backup_count']);
    ...
    public function _junk_files_info()
    {
        ...
        try
        {
            $ret['log_path'] = $log_dir = $wpvivid_plugin->wpvivid_log->GetSaveLogFolder();
    ...
    public function clean_local_storage_ex()
    {
        ...
        try
        {
            ...
            if($options['log']=='1')
            {
                $log_dir=$wpvivid_plugin->wpvivid_log->GetSaveLogFolder();
            ...
            if($options['junk_files']=='1')
            {
                ...
                $dir=WPvivid_Setting::get_backupdir();
                $dir=WP_CONTENT_DIR.DIRECTORY_SEPARATOR. $dir;
                $path=str_replace('/',DIRECTORY_SEPARATOR,$wpvivid_plugin->wpvivid_log->GetSaveLogFolder());
    ...
    public function clean_out_of_date_backup()
    {
        ...
        try
        {
            ...
            update_option('wpvivid_backup_remote_need_update', true);
    ...
    public function output_rollback_backup_count_setting_page()
    {
        $general_setting=WPvivid_Setting::get_setting(true, "");
        ...
        <div>
            <div>
                <p>Rollback</p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="rollback_max_backup_count" id="rollback_max_backup_count" value="<?php esc_attr_e($rollback_max_backup_count); ?>"> (localhost)Rollback Backups retained.</p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="rollback_max_remote_backup_count" id="rollback_max_remote_backup_count" value="<?php esc_attr_e($rollback_max_remote_backup_count); ?>"> (remote storage)Rollback Backups retained.</p>
            </div>
        </div>
        <?php
    }
    ...
    public function _junk_files_info_ex()
    {
        try {
            ...
            $ret['sum_size'] = $wpvivid_plugin->formatBytes($backup_dir_byte + $log_dir_byte);
    ...
    public function output_general_setting()
    {
        ...
        $junk_file['log_path'] = WP_CONTENT_DIR . DIRECTORY_SEPARATOR . $dir .DIRECTORY_SEPARATOR . 'wpvivid_log';
            ...
            <table class="widefat" style="border-left:none;border-top:none;border-right:none;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $tabs['rollback_schedule']['title']='Rollback';
                        $tabs['rollback_schedule']['slug']='rollback_schedule';
                        $tabs['rollback_schedule']['callback']=array($this, 'output_rollback_backup_count_setting_page');
                        $tabs['rollback_schedule']['args']=$args;
                ...
                <tr>
                    ...
                    <td>
                        <p>
                            <input type="text" placeholder="wpvividbackups" option="setting" name="path" id="wpvivid_option_backup_dir" value="<?php esc_attr_e($general_setting['options']['wpvivid_local_setting']['path'], 'wpvivid'); ?>" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" /> Name your folder, this folder must be writable for creating backup files.
                        </p>
                        <p></p>
                        <div>
                            <input type="text" id="wpvivid_backup_prefix" placeholder="Enter prefix (e.g. test)" value="<?php esc_attr_e($prefix); ?>" option="setting" name="backup_prefix" onkeyup="value=value.replace(/[^a-zA-Z0-9._]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" /> Add a prefix to all backup files
    ...
    public function output_advance_setting()
    {
        ...
        $memory_limit=isset($common_setting['memory_limit'])?$common_setting['memory_limit']:'256M';
        ...
        <table class="widefat" style="border-left:none;border-top:none;border-right:none;">
            ...
            <tr>
                <td class="row-title" style="min-width:200px;"><label for="tablecell">Compression method</label></td>
                <td>
                    <div>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
