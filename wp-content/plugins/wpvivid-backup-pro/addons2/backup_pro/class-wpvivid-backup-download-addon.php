...
class WPvivid_Backup_Download_Addon
{
    ...
    public function download_file2()
    {
        ...
        $files[]=$file_name;
        update_option('wpvivid_ready_to_download_files',$files);
    ...
    public function init_prepare_files_task($files,$backup)
    {
        ...
        update_option('wpvivid_prepare_download_files_task',$this->task);
    ...
    public function do_download_file($key)
    {
        ...
        {
            $backup_item = new WPvivid_Backup_Item($this->task['backup']);
            ...
            if($this->task['backup']['type']=='Incremental')
            {
                if($remote_option['type']=='ftp'||$remote_option['type']=='sftp')
                {
                    if(isset($remote_option['custom_path']))
                    {
                        ...
                        $remote_option['custom_path']=$remote_option['custom_path'].'/';
                    }
                    else
                    {
                        //$remote_option['path']=$remote_option['path'].'/'.$this->task['backup']['incremental_path'];
                        $remote_option['path']=$remote_option['path'].'/';
                    }
                }
                else
                {
        ...
        $remote=$wpvivid_plugin->remote_collection->get_remote($this->task['jobs'][$key]['download']['remote_option']);
        ...
        try
        {
            ...
            foreach ($files as $file)
            {
                ...
                else
                {
                    ...
                    {
                        update_option('wpvivid_download_backup_ignore_md5', '1');
                    }
                }
            }
            $ret['result'] = 'success';
