...
class WPvivid_BackupList_addon
{
                ...
                <div>
                    ...
                    <span style="float: left;">
                        <select id="wpvivid_select_backup_folder">
                            ...
                            <option id="wpvivid_migrated_option" value="Migrate">Migrate Backups</option>
    ...
    public function _rescan_remote_folder_set_backup($remote_id,$backups)
    {
        ...
        update_option('wpvivid_new_remote_list',$remote_list);
    }
    ...
    public function _scan_remote_backup($remote_id,$backup_folder)
    {
        ...
        if ($ret['result'] == 'success')
        {
            ...
            update_option('wpvivid_scan_remote_task',$scan_task_data);
...
class WPvivid_New_BackupList
{
    ...
    public function update_backup($backup_id,$key,$data)
    {
        ...
        if(isset($this->backup_list['local'][$backup_id]))
        {
            ...
            update_option('wpvivid_backup_list',$this->backup_list['local']);
            return;
        }
        ...
        foreach($this->backup_list['remote'] as $remote_id=>$list)
        {
            if(isset($list[$backup_id]))
            {
                ...
                update_option('wpvivid_new_remote_list',$this->backup_list['remote']);
                return;
            }
        }
    }
    ...
    {
        $path=WP_CONTENT_DIR.DIRECTORY_SEPARATOR.$backup_data['local']['path'].DIRECTORY_SEPARATOR;
