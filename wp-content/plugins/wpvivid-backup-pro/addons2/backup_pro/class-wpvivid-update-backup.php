                ...
                <div id="wpvivid_auto_backup_block" style="padding-left:2em; <?php esc_attr_e($auto_backup_style); ?>">
                    <fieldset>
                        <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                            <input type="radio" option="setting" name="auto_backup" value="local" <?php esc_attr_e($auto_backup_local); ?> />Save the backup to localhost: <code><?php echo WP_CONTENT_DIR.DIRECTORY_SEPARATOR.$backupdir; ?></code>
