...
use WPvividProGuzzleHttp\Promise\Promise;
use WPvividProGuzzleHttp\Promise\PromiseInterface;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public static function applyDocFilters(array $api, array $docs)
    {
        ...
        $guzzleStreamMessage = "<p>Additional info on behavior of the stream"
            ...
            . " <code>WPvividProGuzzleHttp\Psr7\stream_for</code> method with a is an instance of"
    ...
    public static function addDocExamples($examples)
    {
        $getObjectExample = [
            ...
            'output' => [
                'Body' => 'class WPvividProGuzzleHttp\Psr7\Stream#208 (7) {...}',
                'ContentLength' => '11',
