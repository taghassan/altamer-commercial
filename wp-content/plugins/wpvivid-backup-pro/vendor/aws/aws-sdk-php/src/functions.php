...
use WPvividProGuzzleHttp\Promise\FulfilledPromise;
...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \WPvividProGuzzleHttp\default_user_agent();
    }

    // If Guzzle 5 installed
    if ($version === 5) {
        return \WPvividProGuzzleHttp\Client::getDefaultUserAgent();
    }
...
function guzzle_major_version()
{
    ...
    if (defined('\WPvividProGuzzleHttp\ClientInterface::VERSION')) {
    ...
    } elseif (defined('\WPvividProGuzzleHttp\ClientInterface::MAJOR_VERSION')) {
