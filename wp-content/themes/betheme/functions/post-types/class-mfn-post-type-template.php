...
if (! class_exists('Mfn_Post_Type_Template')) {
	class Mfn_Post_Type_Template extends Mfn_Post_Type
	{
		...
		public function mfn_set_row_post_class($classes, $class, $post_id){
		    ...
		    $screen = get_current_screen();
		    if ('template' != $screen->post_type && 'edit' != $screen->base) return $classes;

		    $tmpl_type = get_post_meta($post_id, 'mfn_template_type', true);
		    $tmpl_type_label = $tmpl_type;

			if( in_array($tmpl_type_label, array('single-product', 'shop-archive')) ){
				$tmpl_type_label = 'woocommerce';
			}else if( in_array($tmpl_type_label, array('single-post')) ){
				$tmpl_type_label = 'blog';
			}else if( in_array($tmpl_type_label, array('section', 'wrap')) ){
				$tmpl_type_label = 'global';
			}else if( in_array($tmpl_type_label, array('single-portfolio')) ){
			...
			return array(
				...
				'fields' => array(
					...
					array(
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:height',
	  					'type' => 'text',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:height_laptop',
	  					'type' => 'text',
	  					'title' => __('Height', 'mfn-opts'),
						'default_unit' => 'px',
						'responsive' => 'laptop',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:height_tablet',
	  					'type' => 'text',
	  					'title' => __('Height', 'mfn-opts'),
						'default_unit' => 'px',
						'responsive' => 'tablet',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:height_mobile',
	  					'type' => 'text',
	  					'title' => __('Height', 'mfn-opts'),
						'default_unit' => 'px',
						'responsive' => 'mobile',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:--mfn-popup-tmpl-offset_laptop',
	  					'type' => 'sliderbar',
	  					'title' => __('Offset', 'mfn-opts'),
	  					'param' => 'number',
						'preview' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content .mfn-popup-tmpl-content-wrapper:padding_laptop',
	  					'type' => 'sliderbar',
	  					'title' => __('Padding', 'mfn-opts'),
	  					'responsive' => 'laptop',
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:border-radius_laptop',
	  					'type' => 'sliderbar',
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'responsive' => 'laptop',
	  					'param' => 'number',
					...
					array(
		  				'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:box-shadow',
		  				'type' => 'box_shadow',
					...
					array(
	  					'id' => 'style:#mfn-popup-template-postid:z-index',
	  					'type' => 'text',
					...
					array(
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:--mfn-exitbutton-size_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'popup_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Button size', 'mfn-opts'),
	  					'responsive' => 'laptop',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .mfn-popup-tmpl-content:--mfn-exitbutton-font-size_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'popup_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Icon size', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .exit-mfn-popup-abs:top_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'popup_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Vertical offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .exit-mfn-popup-abs:--mfn-exitbutton-offset-horizontal_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'popup_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Horizontal offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-popup-template-postid .exit-mfn-popup-abs:border-radius_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'popup_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'param' => 'number',
			...
			return array(
				...
				'fields' => array(
					...
					array(
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-width',
	  					'type' => 'text',
	  					'title' => __('Width', 'mfn-opts'),
						'default_unit' => 'px',
	  					'std' => '400px',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-width_laptop',
	  					'type' => 'text',
	  					'title' => __('Width', 'mfn-opts'),
						'default_unit' => 'px',
	  					'std' => '400px',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-width_tablet',
	  					'type' => 'text',
	  					'title' => __('Width', 'mfn-opts'),
						'default_unit' => 'px',
	  					'std' => '400px',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-width_mobile',
	  					'type' => 'text',
	  					'title' => __('Width', 'mfn-opts'),
						'default_unit' => 'px',
	  					'std' => '400px',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:justify-content',
	  					'type' => 'radio_img',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:justify-content_tablet',
	  					'type' => 'radio_img',
	  					'alias' => 'sidemenu_content_position',
	  					'responsive' => 'tablet',
	  					'title' => __('Content position', 'mfn-opts'),
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:justify-content_mobile',
	  					'type' => 'radio_img',
	  					'alias' => 'sidemenu_content_position',
	  					'responsive' => 'mobile',
	  					'title' => __('Content position', 'mfn-opts'),
  					...
  					array(
						'id' => 'style:#mfn-sidemenu-tmpl-postid:background-color',
						'type' => 'color',
						'title' => __('Background color', 'mfn-opts'),
						'std' => '#fff'
					),
					...
					array(
		  				'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:padding',
		  				'type' => 'dimensions',
		  			...
		  			array(
		  				'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:padding_laptop',
		  				'type' => 'dimensions',
		  				'version' => 'separated-fields',
		  				'title' => __('Padding', 'mfn-opts'),
						'responsive' => 'laptop',
		  			...
		  			array(
		  				'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:padding_tablet',
		  				'type' => 'dimensions',
		  				'version' => 'separated-fields',
		  				'title' => __('Padding', 'mfn-opts'),
						'responsive' => 'tablet',
		  			...
		  			array(
		  				'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:padding_mobile',
		  				'type' => 'dimensions',
		  				'version' => 'separated-fields',
		  				'title' => __('Padding', 'mfn-opts'),
						'responsive' => 'mobile',
					...
					array(
		  				'id' => 'style:#mfn-sidemenu-tmpl-postid:box-shadow',
		  				'type' => 'box_shadow',
		  				'title' => __('Box shadow', 'mfn-opts'),
						'css_attr' => 'box-shadow',
		  			),
					...
					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:z-index',
	  					'type' => 'text',
	  					'title' => __('z-index', 'mfn-opts'),
  					),
					...
					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-size',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Button size', 'mfn-opts'),
	  					'responsive' => 'desktop',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-size_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Button size', 'mfn-opts'),
	  					'responsive' => 'laptop',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-size_tablet',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Button size', 'mfn-opts'),
	  					'responsive' => 'tablet',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-size_mobile',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Button size', 'mfn-opts'),
	  					'responsive' => 'mobile',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-font-size',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Icon size', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-font-size_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Icon size', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-font-size_tablet',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Icon size', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid:--mfn-sidemenu-closebutton-font-size_mobile',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Icon size', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:top',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Vertical offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:top_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Vertical offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:top_tablet',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Vertical offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:top_mobile',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Vertical offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:--mfn-sidemenu-closebutton-offset-horizontal',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Horizontal offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:--mfn-sidemenu-closebutton-offset-horizontal_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Horizontal offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:--mfn-sidemenu-closebutton-offset-horizontal_tablet',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Horizontal offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:--mfn-sidemenu-closebutton-offset-horizontal_mobile',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Horizontal offset', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:border-radius',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:border-radius_laptop',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:border-radius_tablet',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:border-radius_mobile',
	  					'type' => 'sliderbar',
	  					'condition' => array( 'id' => 'sidemenu_close_button_active', 'opt' => 'is', 'val' => '1' ),
	  					'title' => __('Border radius', 'mfn-opts'),
	  					'param' => 'number',
  					...
  					array(
						'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:color',
						'type' => 'color',
						'title' => __('Color', 'mfn-opts'),
					),

  					array(
						'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton:background-color',
						'type' => 'color',
						'title' => __('Background color', 'mfn-opts'),
					),
					...
					array(
						'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton|hover:color',
						'type' => 'color',
						'title' => __('Color', 'mfn-opts'),
					),

  					array(
						'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-closebutton|hover:background-color',
						'type' => 'color',
						'title' => __('Background color', 'mfn-opts'),
					),
      ...
      if ( is_admin() && $query->get('post_type') == 'template' && ( !$query->get('post_status') || empty($query->get('post_status')) ) ) {
		...
		public function list_tabs_wrapper($actions) {
			...
			<ul class="mfn-template-filters">
				<li><a href="?post_type=template" class="nav-tab <?php if(empty($tab)):?>nav-tab-active<?php endif; ?>">All</a>
				<li><a href="?post_type=template&tab=header" class="nav-tab mfn-label-nav-tab mfn-label-header <?php if($tab==='header'):?>nav-tab-active<?php endif; ?>">Header <span class="mfn-label-counter"><?php echo count($headers); ?></span></a></li>
				
				<li><a href="?post_type=template&tab=megamenu" class="nav-tab mfn-label-nav-tab mfn-label-megamenu <?php if($tab==='megamenu'):?>nav-tab-active<?php endif; ?>">Mega menu <span class="mfn-label-counter"><?php echo count($megamenus); ?></span></a></li>
				<li><a href="?post_type=template&tab=sidemenu" class="nav-tab mfn-label-nav-tab mfn-label-sidemenu <?php if($tab==='sidemenu'):?>nav-tab-active<?php endif; ?>">Sidebar menu <span class="mfn-label-counter"><?php echo count($sidebars); ?></span></a></li>

				<li><a href="?post_type=template&tab=footer" class="nav-tab mfn-label-nav-tab mfn-label-footer <?php if($tab==='footer'):?>nav-tab-active<?php endif; ?>">Footer <span class="mfn-label-counter"><?php echo count($footers); ?></span></a></li>
				<li><a href="?post_type=template&tab=popup" class="nav-tab mfn-label-nav-tab mfn-label-popup <?php if($tab==='popup'):?>nav-tab-active<?php endif; ?>">Popup <span class="mfn-label-counter"><?php echo count($popups); ?></span></a></li>

				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=single-post" class="nav-tab mfn-label-nav-tab mfn-label-blog <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Blog <span class="mfn-label-counter"><?php echo (count($blogs)+count($posts)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a style="pointer-events: none; opacity: 0.5;" href="?post_type=template&tab=blog" class="nav-tab mfn-label-nav-tab mfn-label-blog <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Archive (soon)</a></li>
						<li><a href="?post_type=template&tab=single-post" class="nav-tab mfn-label-nav-tab mfn-label-blog <?php if($tab==='single-post'):?>nav-tab-active<?php endif; ?>">Single post <span class="mfn-label-counter"><?php echo count($posts); ?></span></a></li>
					</ul>
				</li>

				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=single-portfolio" class="nav-tab mfn-label-nav-tab mfn-label-portfolio <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Portfolio <span class="mfn-label-counter"><?php echo (count($portfolios)+count($singleportfolios)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a style="pointer-events: none; opacity: 0.5;" href="?post_type=template&tab=blog" class="nav-tab mfn-label-nav-tab mfn-label-portfolio <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Archive (soon)</a></li>
						<li><a href="?post_type=template&tab=single-portfolio" class="nav-tab mfn-label-nav-tab mfn-label-portfolio <?php if($tab==='single-portfolio'):?>nav-tab-active<?php endif; ?>">Single post <span class="mfn-label-counter"><?php echo count($singleportfolios); ?></span></a></li>
					</ul>
				</li>

				<?php if(function_exists('is_woocommerce')): ?>
				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=shop-archive" class="nav-tab mfn-label-nav-tab mfn-label-woocommerce <?php if($tab==='shop-archive'):?>nav-tab-active<?php endif; ?>">WooCommerce <span class="mfn-label-counter"><?php echo (count($products) + count($shops)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a href="?post_type=template&tab=shop-archive" class="nav-tab mfn-label-nav-tab mfn-label-woocommerce <?php if($tab==='shop-archive'):?>nav-tab-active<?php endif; ?>">Shop <span class="mfn-label-counter"><?php echo count($shops); ?></span></a></li>
						<li><a href="?post_type=template&tab=single-product" class="nav-tab mfn-label-nav-tab mfn-label-woocommerce <?php if($tab==='single-product'):?>nav-tab-active<?php endif; ?>">Single product <span class="mfn-label-counter"><?php echo count($products); ?></span></a></li>
					</ul>
				</li>
				<?php endif; ?>

				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=section" class="nav-tab mfn-label-nav-tab mfn-label-global <?php if($tab==='section'):?>nav-tab-active<?php endif; ?>">Global <span class="mfn-label-counter"><?php echo (count($sections)+count($wraps)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a href="?post_type=template&tab=section" class="nav-tab mfn-label-nav-tab mfn-label-global <?php if($tab==='section'):?>nav-tab-active<?php endif; ?>">Sections <span class="mfn-label-counter"><?php echo count($sections); ?></span></a></li>
						<li><a href="?post_type=template&tab=wrap" class="nav-tab mfn-label-nav-tab mfn-label-global <?php if($tab==='wrap'):?>nav-tab-active<?php endif; ?>">Wraps <span class="mfn-label-counter"><?php echo count($wraps); ?></span></a></li>
					</ul>
				</li>

				<li><a href="?post_type=template&tab=default" class="nav-tab mfn-label-nav-tab mfn-label-default <?php if($tab==='default'):?>nav-tab-active<?php endif; ?>">Page <span class="mfn-label-counter"><?php echo count($pages); ?></span></a></li>
