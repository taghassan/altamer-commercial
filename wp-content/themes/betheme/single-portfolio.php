...
<div id="Content" class="<?php echo esc_attr($class); ?>">
	<div class="content_wrapper clearfix">
		...
		<main class="sections_group">
			...
			$tmp_id = mfn_single_post_ID( 'single-portfolio' );

			if( ( empty($_GET['visual']) || !empty($_GET['mfn-template-id']) ) && !empty( $tmp_id ) && is_numeric( $tmp_id ) && get_post_type( $tmp_id ) == 'template' && get_post_status( $tmp_id ) == 'publish' ){
