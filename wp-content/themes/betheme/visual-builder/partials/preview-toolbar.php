...
echo '<div class="mfn-preview-toolbar mfn-header mfn-header-green header-large">';
    ...
    echo '<a class="mfn-option-btn mfn-option-blank-dark btn-large mfn-preview-opt" data-preview="laptop" title="Laptop" href="#" data-tooltip="Laptop" href="#" data-position="bottom"><span class="mfn-icon mfn-icon-laptop-light"></span></a>';
