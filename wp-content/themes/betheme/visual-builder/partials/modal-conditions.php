		...
		<div class="modalbox-content">
			...
			<div class="mfn-dynamic-form mfn-form">
				...
				if (function_exists('is_woocommerce')) {
					...
					$tags = $wpdb->get_results( "SELECT tt.term_id, te.name FROM {$wpdb->prefix}term_taxonomy tt INNER JOIN {$wpdb->prefix}terms te ON tt.term_id = te.term_id WHERE tt.taxonomy = 'product_tag' Limit 100 " );
				}
				...
				<?php elseif( $this->template_type && in_array($this->template_type, array('single-post')) ):
				...
				<div class="mfn-df-row">
					<div class="df-row-inputs">
						...
						<select name="mfn_template_conditions[<?php echo $x; ?>][var]" class="mfn-form-control df-input df-input-var">
							<option <?php if($cond->var == 'all'){ echo 'selected'; } ?> value="all">All posts</option>
							<option <?php if($cond->var == 'category'){ echo 'selected'; } ?> value="category">Category</option>
							<option <?php if($cond->var == 'post_tag'){ echo 'selected'; } ?> value="post_tag">Tag</option>
						</select>
				...
				<?php elseif( $this->template_type && in_array($this->template_type, array('single-portfolio')) ):
				...
				<div class="mfn-df-row">
					<div class="df-row-inputs">
						...
						<select name="mfn_template_conditions[<?php echo $x; ?>][var]" class="mfn-form-control df-input df-input-var">
							<option <?php if($cond->var == 'all'){ echo 'selected'; } ?> value="all">All porojects</option>
							<option <?php if($cond->var == 'portfolio-types'){ echo 'selected'; } ?> value="portfolio-types">Category</option>
						</select>
				...
				<div class="mfn-df-row clone">
					<div class="df-row-inputs">
						...
						<select data-name="mfn_template_conditions[0][var]" class="mfn-form-control df-input df-input-var">
							<option value="all">All porojects</option>
							<option value="portfolio-types">Category</option>
						</select>
